...
frequent = "!#%$&)(+*@[]_^{}"
# characters = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
characters = """"""
letters = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"

# print re.sub(r"\s+", "", characters)
matches = re.findall(r"[^A-Z][A-Z]{3}([a-z]{1})[A-Z]{3}[^A-Z]", characters)
smalls = ""
for m in matches:
    print m
    smalls += m
...
#     match = l + l + l
#     print match
#     print characters.count(match)
    # if characters.count(match) > 0:
    #     print match
